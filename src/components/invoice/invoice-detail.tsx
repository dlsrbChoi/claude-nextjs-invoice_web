...
export function InvoiceDetail({ invoice }: InvoiceDetailProps) {
  ...
  return (
    <Container>
      ...
      {/* 클라이언트 정보 */}
      <Card className="p-6 print:border-0 print:bg-transparent print:p-0 print:shadow-none">
        <h3 className="text-sm font-semibold text-muted-foreground uppercase tracking-wide mb-3">청구 대상</h3>
      ...
      <Card className="p-6 print:border-0 print:bg-transparent print:p-0 print:shadow-none">
        <h3 className="text-sm font-semibold text-muted-foreground uppercase tracking-wide mb-4">항목</h3>
